		...
		AbstractAtomicityRegisterClient
{
	 ...
	 */
	private Version cached_version = new Version(-1, SessionManager.getNewInstance().getNodeId());
	...
	{
		this.cached_version = cached_version.increment(SessionManager.getNewInstance().getNodeId());
...
//		Log.d(TAG, "Begin to get value associated with Key = " + key.toString());
	...
	/* 
	 * @see ics.mobilememo.sharedmemory.atomicity.AbstractAtomicityRegisterClient#put(ics.mobilememo.sharedmemory.Key, java.lang.String)
	 * 
